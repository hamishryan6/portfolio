...
import PGWWebsite from '../../assets/images/pgw-website.png'
        ...
        <div className='Page__Main'>
            ...
            <div className='Section__Content'>
                <PortfolioItem
                    ...
                    software={['Figma', 'React', 'Typescript']}
                    links={[{
                        label: 'GitHub',
                ...
                <PortfolioItem
                    ...
                    tags={['Design', 'Frontend', 'Backend']}
                    software={['CSS', 'HTML', 'Firebase', 'Webflow', 'XD']}
                    links={[{
                        label: 'Website',
                ...
                <PortfolioItem
                    ...
                    software={['Illustrator', 'Lottie', 'Photoshop', 'React', 'XD']}
                    links={[{
                        label: 'App Store',
                ...
                <PortfolioItem
                    ...
                    tags={['Design', 'Frontend']}
                    software={['Figma', 'Illustrator', 'React']}
                    links={[{
                        label: 'Website',
